...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/${PLATFORM}/foom.exe

dist/Debug/${PLATFORM}/foom.exe: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/${PLATFORM}
	${LINK.c} -o dist/Debug/${PLATFORM}/foom ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/src/foom_objects.o: src/foom_objects.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_objects.o src/foom_objects.c

${OBJECTDIR}/src/foom_classes/foom_func.o: src/foom_classes/foom_func.c 
	${MKDIR} -p ${OBJECTDIR}/src/foom_classes
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_classes/foom_func.o src/foom_classes/foom_func.c

${OBJECTDIR}/src/foom_lex.o: src/foom_lex.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_lex.o src/foom_lex.c
...
${OBJECTDIR}/src/foom_classes/foom_str.o: src/foom_classes/foom_str.c 
	${MKDIR} -p ${OBJECTDIR}/src/foom_classes
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_classes/foom_str.o src/foom_classes/foom_str.c
...
${OBJECTDIR}/src/foom_libs/foom_lib.o: src/foom_libs/foom_lib.c 
	${MKDIR} -p ${OBJECTDIR}/src/foom_libs
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_libs/foom_lib.o src/foom_libs/foom_lib.c
...
${OBJECTDIR}/src/foom_test.o: src/foom_test.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_test.o src/foom_test.c

${OBJECTDIR}/src/foom_classes/foom_map.o: src/foom_classes/foom_map.c 
	${MKDIR} -p ${OBJECTDIR}/src/foom_classes
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_classes/foom_map.o src/foom_classes/foom_map.c

${OBJECTDIR}/src/foom_libs/foom_sys.o: src/foom_libs/foom_sys.c 
	${MKDIR} -p ${OBJECTDIR}/src/foom_libs
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_libs/foom_sys.o src/foom_libs/foom_sys.c

${OBJECTDIR}/src/foom_classes/foom_obj.o: src/foom_classes/foom_obj.c 
	${MKDIR} -p ${OBJECTDIR}/src/foom_classes
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_classes/foom_obj.o src/foom_classes/foom_obj.c

${OBJECTDIR}/src/foom_ast.o: src/foom_ast.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_ast.o src/foom_ast.c
...
${OBJECTDIR}/src/foom_class.o: src/foom_class.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Wall -Iheaders -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/foom_class.o src/foom_class.c
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/${PLATFORM}/foom.exe
